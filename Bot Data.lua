return {
    ...
    Name = {
        ...
        'TheLongrangeRifle_', 'HOLDINGNEXT', 'yieviro92creepy', 'HarmSocietyBot', 'Cxnvicted', 'SolicitRunsYou'
    },

    Display = {
        'TheAloneSystems', 'sleepinbot', 'sleepnbetter', 'ILuvOven', 'skidbottingera2', 'LOSTRITUALOWNSYOU', 'prunebot', 'yieviro92creepy',
        'Killhousebot', 'MestalicFlungYouLOL', 'blowupsASSisLARGE', 'Deskoard_9s7R7GdUGz', 'kronebot', 'improved01', 'NETWORK', 'cutesillybak_', 'SnipedByCyber'
    },

    FilterMessage = {
        '.gg/shhh', '| Hold', 'dis//shh', '@krone', '.gg/gravesite', '@murder', '.ggvwl', 'purchase whitelist', 'purchase a whitelist',
        '@gesture', 'gesture#', '.gg/gravesite', 'Tox1chappy', 'nAdwzx7Bsk', 'join for ', 'join .gg', '/solicit'
    }
};
